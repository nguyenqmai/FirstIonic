...
export class NotificationsPage {
  ...
  public insertRandomNotification() {
    ...
    this.fcm.saveNotification(<FcmNotification>notification).then(() =>  { this.refreshAllNotifications() });
  }

  public deleteNotification(itemKey: string) {
    this.fcm.deleteNotification(itemKey).then(() => {this.refreshAllNotifications()});
  }
